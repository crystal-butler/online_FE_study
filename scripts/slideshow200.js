	...
	function()
	{
		...
		$.getJSON('data/faces.json', function(d)
		{
			...
			$("input.submitEmotion").on("click", function()
			{
				...
				emotion200.push($("#emotion :radio:checked").val());
				console.log(emotion200);
				// emotion200=$("#emotion").serializeArray();
				// var emotion200=[emotion200[0].name, emotion200[0].value];
				// console.log(emotion200);
				...
				{	
					$.cookie('emotion200', emotion200.toString());
					var image = d[i];
					$("figcaption").hide();
					$(".nextButton").show();
					return false;
